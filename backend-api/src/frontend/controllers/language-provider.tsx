...
const dictionary: Dictionary = {
  ...
  exportSelectedReport: "Ekspor Laporan Ini",
  receipt: "Struk",
  profile: "Profil",
  ...
  loggingOut: "Keluar...",
  boundaryNotice:
    "Transaksi kasir, shift, sinkronisasi offline, dan penjualan harian bisa dijalankan dari menu Kasir web atau APK Flutter. Dasbor ini tetap dipakai untuk master data, monitoring laporan, audit, dan konfigurasi backend.",
  ...
  loadingStats: "Memuat statistik dasbor...",
  dashboardStatsError: "Statistik dasbor belum bisa dimuat.",
  ...
  loadingAlerts: "Memuat peringatan operasional...",
  ...
  exportFinancialReport: "Ekspor Laporan Keuangan",
  exporting: "Mengekspor...",
  financialExportTitle: "Ekspor laporan keuangan UMKM",
  financialExportDenied: "Akses ekspor belum diizinkan",
  financialExportDeniedDesc: "Aktifkan izin Ekspor pada menu Laporan untuk role ini.",
  financialExportSuccess: "Laporan keuangan berhasil diekspor",
  ...
  financialExportFailed: "Laporan keuangan gagal diekspor",
  financialExportFailedDesc: "Coba refresh laporan atau periksa akses outlet.",
  profitLossDesc: "Pendapatan, HPP, laba kotor, remahan, dan laba operasional sederhana.",
