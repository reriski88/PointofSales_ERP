...
export function AdminModal(props: {
  ...
  const modal = (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/45 p-2 sm:p-3" role="dialog" aria-modal="true">
      ...
      <div className={`relative flex max-h-[92vh] w-full ${widthClass} flex-col overflow-hidden rounded-xl bg-card shadow-xl`}>
        ...
        <div className="thin-y-scroll min-h-0 overflow-y-auto p-4 sm:p-5">{props.children}</div>
      </div>
    </div>
  );
